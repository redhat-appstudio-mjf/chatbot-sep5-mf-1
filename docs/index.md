...
!!! info
    ...
    **Source Code Repository:** [https://github.com/redhat-appstudio-mjf/chatbot-sep5-mf-1](https://github.com/redhat-appstudio-mjf/chatbot-sep5-mf-1)

    **GitOps Repository:** [https://github.com/redhat-appstudio-mjf/chatbot-sep5-mf-1-gitops](https://github.com/redhat-appstudio-mjf/chatbot-sep5-mf-1-gitops)

# **Usage**

To access the chatbot-sep5-mf-1 application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of chatbot-sep5-mf-1. You can access this namespace through the web console or via your CLI.
